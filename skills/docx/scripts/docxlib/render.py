...
def render_docx(
    ...
    *,
    ...
    with tempfile.TemporaryDirectory(prefix="rigorium_soffice_profile_") as profile_dir:
        with tempfile.TemporaryDirectory(prefix="rigorium_soffice_output_") as convert_dir:
