// Service Worker for Rigorium PWA
...
self.addEventListener('push', event => {
  ...
  try {
    ...
    payload = { title: 'Rigorium', body: event.data.text() };
  }
  ...
  event.waitUntil(
    self.registration.showNotification(payload.title || 'Rigorium', options)
  );
});
