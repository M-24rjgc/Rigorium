...
import rigoriumLogoDark from '../../../assets/rigorium-wordmark-dark.png';
import rigoriumLogoLight from '../../../assets/rigorium-wordmark-light.png';
