import { applyConfigToProcessEnv } from './rigoriumConfig.js';
...
// during the Rigorium-only migration and the schema no longer carries them.
export async function reloadRigoriumConfig(config) {
  const result = {
