...
import type { RigoriumToolErrorResult, RigoriumToolResult } from "../../tool/index.js";
...
export function ensureToolResultPairing(
  ...
  const resultsByCallId = new Map<string, RigoriumToolResult[]>();
  ...
  const paired: RigoriumToolResult[] = [];
