...
import { toCanonicalToolResultBlock, type RigoriumToolResult, type RigoriumToolResultContent } from "../../tool/index.js";

function toCanonicalSupplementalBlock(content: RigoriumToolResultContent): CanonicalToolResultContentBlock {
...
export function projectToolResults(results: RigoriumToolResult[]): CanonicalMessage[] {
