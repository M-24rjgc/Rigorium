...
export type SubagentDefinition = {
  ...
  description: string;
  /**
   * Allowed tool names (canonical Rigorium tool names). Use `["*"]` for
...
const SHARED_PREFIX = `You are a subagent of Rigorium — a focused agent dispatched by the parent agent to handle a bounded research, planning, or verification task.
