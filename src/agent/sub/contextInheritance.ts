 ...
 *
 * In Rigorium the only "context blocks" we have today are encoded as XML-like
...
import type { RigoriumReadFileStateMap, RigoriumWriteSnapshotMap } from "../../tool/index.js";

/** Read-file freshness cache contract. Match the shape used by `read_file`. */
export type ReadFileStateMap = RigoriumReadFileStateMap;
export type ReadFileStateEntry = ReadFileStateMap extends Map<string, infer T> ? T : never;
export type WriteSnapshotMap = RigoriumWriteSnapshotMap;
