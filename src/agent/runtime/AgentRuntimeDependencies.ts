...
export type AgentRuntimeDependencies = {
  ...
  tools: {
    scheduler: RigoriumToolScheduler;
  ...
  /**
   * Elicitation channel — wired into the per-tool `RigoriumToolRuntimeContext`
  ...
  /**
   * Plan file manager — resolves the project-local `.rigorium/plans`
