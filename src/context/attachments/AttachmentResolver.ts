        ...
        diagnostics: [
          {
            code: "attachment_too_large",
            severity: "warning",
            message: `Image ${absolute} is ${info.size} bytes (limit ${this.maxImageBytes}); skipped (Rigorium does not resize, intentional_difference §4.5).`,
          },
        ],
      };
    }
      ...
      diagnostics: [
        {
          ...
          severity: "info",
          message: "Rigorium does not resize images; original bytes forwarded (intentional_difference §4.5).",
        },
      ],
    };
  }
      ...
      diagnostics: [
        {
          ...
          severity: "info",
          message: `Estimated ${estimatedPages} pages from ${info.size} bytes (Rigorium does not invoke pdfinfo, intentional_difference §4.5).`,
        },
      ],
    };
  }
