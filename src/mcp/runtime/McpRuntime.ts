...
export class McpRuntime {
  ...
  constructor(
    public readonly servers: RigoriumMcpServerSpec[],
  ...
  async listAllTools(): Promise<RigoriumMcpToolSpec[]> {
    const out: RigoriumMcpToolSpec[] = [];
  ...
  getInstructions(): RigoriumMcpServerInstructions[] {
    const out: RigoriumMcpServerInstructions[] = [];
    for (const client of this.clients.values()) {
      if (client.getStatus() !== "ready") continue;
  ...
  statuses(): RigoriumMcpClientStatusEntry[] {
