 ...
 */
export class ConcurrentToolScheduler implements RigoriumToolScheduler {
  constructor(
  ...
  async executeAll(
    ...
    const resultSlots = new Array<RigoriumToolResult | undefined>(calls.length);
    ...
    return resultSlots as RigoriumToolResult[];
  }
}
