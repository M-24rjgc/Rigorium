...
import type { RigoriumDeepSeekNativeSearchConfig } from "./types.js";
...
export type ResolveDeepSeekNativeSearchConfigInput = {
  nativeSearch?: RigoriumDeepSeekNativeSearchConfig | DeepSeekNativeSearchSettings;
 ...
 * variables; this adapter owns Rigorium's optional model-provider reuse.
 */
